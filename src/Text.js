...
<div>
        ...
        <div>
            <div className='text'>
                <h2>Clean Meets Clinical</h2>
                <p>Love clinical skincare, but want to limit your exposure to certain ingredients? Try “Cleanical” skincare. 
                This is where clean skincare meets science. We’re talking clinical skincare products backed by science from 
                doctors you love and trust, formulated without the ingredients you don't. You no longer have to decide between
                clean formulas and visible results. Whether you’re looking to support your skin barrier, target acne, brighten 
                dark spots and hyperpigmentation, or get more youthful-looking skin, Cleanical skincare at Sephora has you covered.</p>
            ...
            <div className="box">
                ...
                <div className="boxItem">
                <h3>Radiance</h3>
                    <p>Maybe you've spent too much time in the sun back in the day, or maybe you've got a habit of picking your face. Either way, you've likely been left with hyperpigmentation and pesky dark spots. That's where Cleanical skincare comes in. Sephora carries formulas that help you achieve a more even skin tone and keep it for the long haul.</p>
                </div>
            </div>
            <div className="box">
                <div className="boxItem">
