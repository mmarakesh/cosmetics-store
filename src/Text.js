...
<div>
        ...
        <div>
            ...
            <div className="box">
                <div className="boxItem">
                <h3>{t('Acne')}</h3>
                <p>{t('If you’ve ever dealt with acne, you know how frustrating it can be. Improve the appearance of acne and restore your confidence with the help of Cleanical skincare. These picks are scientifically proven to help treat current breakouts and prevent future ones without triggering any sensitivities.')}</p>
                </div>
                <div className="boxItem">
